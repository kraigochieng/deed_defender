...
@dataclasses.dataclass(kw_only=True)
class InvokeIncrementCounterArgs(_ArgsBase[int]):
    @staticmethod
    def method() -> str:
        return "invoke_increment_counter()uint64"


@dataclasses.dataclass(kw_only=True)
class DecrementCounterArgs(_ArgsBase[int]):
    @staticmethod
    def method() -> str:
        return "decrement_counter()uint64"
...
class Composer:
    ...
    def invoke_increment_counter(
        self,
        *,
        transaction_parameters: algokit_utils.TransactionParameters | None = None,
    ) -> "Composer":
        """Adds a call to `invoke_increment_counter()uint64` ABI method
        
        :param algokit_utils.TransactionParameters transaction_parameters: (optional) Additional transaction parameters
        :returns Composer: This Composer instance"""

        args = InvokeIncrementCounterArgs()
    ...
    def decrement_counter(
        ...
        *,
        ...
        """Adds a call to `decrement_counter()uint64` ABI method
        
        :param algokit_utils.TransactionParameters transaction_parameters: (optional) Additional transaction parameters
        :returns Composer: This Composer instance"""

        args = DecrementCounterArgs()
        self.app_client.compose_call(
            self.atc,
            call_abi_method=args.method(),
            transaction_parameters=_convert_call_transaction_parameters(transaction_parameters),
...
class CounterClient:
    ...
    def invoke_increment_counter(
        ...
        *,
        ...
        """Calls `invoke_increment_counter()uint64` ABI method
    ...
    def decrement_counter(
        ...
        *,
        ...
        """Calls `decrement_counter()uint64` ABI method
